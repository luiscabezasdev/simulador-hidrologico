...
- **Decision**: Feature detection de `HTMLCanvasElement`; si no está soportado, se oculta el canvas y se muestra la tabla HTML alternativa (ya presente por R2/R5) junto con un mensaje explicativo dirigido al estudiante.
